...
public class UpdateEventExceptionDocs implements SwaggerExceptionDoc {
    ...
    @ExplainError("이벤트가 종료된 상태에서 수정 요청이 들어올 때 발생하는 예외입니다")
    public static final BusinessException 종료된_이벤트는_수정할_수_없을_때 =
            CloseEventCannotBeUpdatedException.EXCEPTION;
